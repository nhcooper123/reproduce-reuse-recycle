...
This script creates summary numbers and plots for all variables, this is primarily for data exploration and understanding prior to creating figures and tables for the paper itself. Some numbers from this script are used in the body of the text in the paper.
...
```{r}
papers <- read_csv(here("data/BES-data-code-hackathon-cleaned_2025-12-01.csv"))
```
...
### How many papers from each year?

```{r}
year_summary <-
  papers %>%
  group_by(year_published) %>%
  summarise(count = n(), percent = count/1861*100)
